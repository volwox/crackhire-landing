...
export function Button({
  ...
  if (typeof href === 'string') {
    // Remove href/target/rel from spread props to avoid duplicates + enforce same-tab
    const { href: _ignoredHref, target: _ignoredTarget, rel: _ignoredRel, onClick, ...rest } =
